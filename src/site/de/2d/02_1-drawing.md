...
{{ definition('rect', [
  ...
  { name: 'Eckradius-oben-links', type: 'number' },
  { name: 'Eckradius-oben-rechts', type: 'number' },
  { name: 'Eckradius-unten-rechts', type: 'number' },
  { name: 'Eckradius-unten-links', type: 'number' }
]) }}
```js
rect(10, 10, 40, 20);
```
